      ...
      <nav className="flex flex-1 flex-col mt-5">
        <ul role="list" className="flex flex-1 flex-col gap-y-7">
          ...
          <li>
            ...
            <div className="text-xs font-semibold leading-6 text-indigo-200">{products.header}</div>
            <ul role="list" className="-mx-2 mt-2 space-y-1">
            ...
            <div className="text-xs font-semibold leading-6 text-indigo-200">{clients.header}</div>
            <ul role="list" className="-mx-2 mt-2 space-y-1">
