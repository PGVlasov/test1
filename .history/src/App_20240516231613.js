...
function App() {
  return (
    <>
      <div className="flex flex-col max-w-mdbg-indigo-500">
        <nav className="flex flex-col max-w-md bg-indigo-500">
          <ul role="list">
            <li >
              <a
                href="#"
                className="flex flex-row items-center gap-x-4 px-6 py-3 text-sm font-semibold leading-6 text-white hover:bg-indigo-300 rounded-full bg-indigo-500"
              >
                <img
            ...
            <li>
              <div >Your teams</div>
              <ul role="list" className="-mx-2 mt-2 space-y-1 bg-indigo-500">
                {orders.map((team) => (
                  <li key={team.name}>
                    <a
                      href={team.href}
